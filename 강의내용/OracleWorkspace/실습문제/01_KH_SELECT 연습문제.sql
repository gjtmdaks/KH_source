...
SELECT EMP_NAME 이름, (SALARY*12) "연봉", (SALARY+SALARY*BONUS)*12 AS 총수령액,
((SALARY+SALARY*BONUS)*12)-(SALARY*12*0.03) AS "실수령액"
FROM EMPLOYEE
WHERE BONUS IS NOT NULL;

SELECT EMP_NAME 이름, (SALARY*12) 연봉, (SALARY*12) 총수령액, (SALARY*12)-(SALARY*12*0.03) 실수령액
FROM EMPLOYEE
WHERE BONUS IS NULL;
...
FROM EMPLOYEE
WHERE BONUS IS NOT NULL
AND ((SALARY+SALARY*BONUS)*12)-(SALARY*12*0.03) >= 50000000;

SELECT EMP_NAME, SALARY, (SALARY*12)-(SALARY*12*0.03) 실수령액, HIRE_DATE
FROM EMPLOYEE
WHERE BONUS IS NULL
AND (SALARY*12)-(SALARY*12*0.03) >= 50000000;
