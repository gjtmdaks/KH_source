...
*/
-- EMPLOYEE테이블에 사원 정보를 추가
INSERT INTO EMPLOYEE
VALUES(900,'김갑생','971005-2211221','RUDALS@NAVER.COM',
'01012345678','D1','J7','S6',1800000,0.2,200,SYSDATE,NULL,DEFAULT);

/*
    2) INSERT INTO 테이블명(칼럼1, 칼럼2, ...) VALUES(값1, 값2, ...)
     - 테이블에 특정칼럼들만 선택하여 그 컬럼에 추가할 값을 제시할 경우 사용.
     - 선택되지 않은 컬럼은 NULL값 혹은 DEFAULT설정이 완료된 경우 DEFAULT값이 추가된다.
     - NOT NULL칼럼 중, DEFAULT값 설정이 되지 않은 칼럼은 필수로 값을 추가해야 한다.
*/
...
/*
    * INSERT ALL 계열
    ...
    1) INSERT ALL
       INTO 테이블1 VALUES(칼럼명1, 칼럼명2, ...)
       INTO 테이블2 VALUES(칼럼명1, 칼럼명2, ...)
       ...
       서브쿼리
*/
...
FROM EMPLOYEE
WHERE 1=0; -- 명시적인 FALSE -> 행 정보만 가져옴
...
-- EMPLOYEE의 제약조건으로 인해 NULL 변경 불가
